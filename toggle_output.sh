...
# Define the card identifier (hardcoded - this is good!)
card_identifier="alsa_card.pci-0000_00_1f.3"

# Define the two profiles
profile1="output:analog-stereo+input:analog-stereo" # Headphones
profile2="output:iec958-stereo+input:analog-stereo" # Speakers
